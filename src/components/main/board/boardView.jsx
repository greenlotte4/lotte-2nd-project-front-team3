            ...
            <article className="page-list">
                <section className="h-auto">
                    ...
                    <div className="bg-gray-50 p-4 border-t border-b border-slate-200">
                        <h3 className="text-lg font-semibold mb-3 cursor-pointer">첨부파일</h3>
                        ...
                        {post.attachedFiles.map((file, index) => (
                            ...
                            >
                            <span className="text-gray-700 block cursor-pointer">{file.name}</span>
                            <span className="text-gray-500 text-sm block cursor-pointer">{file.size}</span>
                            </div>
                        ))}
                        </div>
                    </div>
                    ...
                    <div className="pt-6 pb-12 border-slate-200">
                        <div className="prose max-w-none">
                            ...
                            <div className="w-1/2 h-auto mt-7">
                                <img className="w-full block" src="/images/Antwork/board/boardExam3.jpeg" alt="게시글 본문 이미지" />
                            </div>
                        </div>
                    </div>
