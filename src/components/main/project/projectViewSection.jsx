export default function ProjectViewSection() {
  return (
    <>
      <article classNameName="page-list">
        <div classNameName="content-header">
          <div classNameName="max-w-9xl mx-auto p-6">
            ...
            <section className="flex gap-4 overflow-x-auto pb-6">
              <article className="flex-shrink-0 w-96  rounded-lg bg-white border border-blue-200">
                ...
                <section className="p-3 min-h-[calc(100vh-16rem)] bg-blue-50/50">
                  <article className="bg-white rounded-lg p-4 shadow-sm mb-3 cursor-pointer hover:shadow-md transition-shadow border border-gray-100">
