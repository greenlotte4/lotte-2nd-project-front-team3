...
<aside className={`sidebar ${!asideVisible ? "hidden" : ""} table-cell`}>
  ...
  <div className="mt-6">
    <div className="flex items-center justify-between">
      ...
      >
        <span
          className={`w-6 h-6 flex items-center justify-center rounded-full text-lg transition-transform ${
            toggleStates.isPersonalOpen ? "rotate-180" : ""
          }`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
  ...
  <div className="mt-6">
    <div className="flex items-center justify-between">
      ...
      >
        <span
          className={`w-6 h-6 flex items-center justify-center rounded-full text-lg transition-transform ${
            toggleStates.isChannelOpen ? "rotate-180" : ""
          }`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
