...
export default function LendingPayPage({ children }) {
  return (
    <LendingLayout>
      <div className="pay-container">
        <div className="content-left">
          <h1 className="title">제품 및 가격안내</h1>
          <img src="../../../public/images/Lending/payyb.png"></img>
          ...
          <div className="footer">
            ...
            <div className="payment-methods">
              <p>결제 수단</p>
              <img
                src="../../../public/images/Lending/payment.png"
                alt="Payment Methods (Visa, Mastercard, etc.)"
              />
              <img
                src="../../../public/images/Lending/paymentbottom.png"
                alt="Payment Methods (Visa, Mastercard, etc.)"
              />
            </div>
          </div>
